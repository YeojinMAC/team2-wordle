  ...
  for (let i = 0; i < keyboard.length; i++) {
    ...
    for (let j = 0; j < currRow.length; j++) {
      ...
      if (key == "Enter") {
        ...
        keyTile.classList.add("enter-key-tile-extra");
      } else {
...
function update() {
  ...
  for (let c = 0; c < width; c++) {
    ...
    if (correct == width) {
      ...
      // document.getElementById("congratulationsGif").style.backgroundImage = "./congrats.gif";
      document.getElementById("gameInstructions").innerHTML = "";
      document.getElementById("keyBoard").style.display = "none";
      document.getElementById("playAgainBtn").innerHTML =
        "<a href = 'wordle.html'>Play Again</a>";
      document.getElementById("notInWordList").style.display = "none";
  ...
  for (let c = 0; c < width; c++) {
    ...
    if (!currTile.classList.contains("correct")) {
      ...
      if (word.includes(letter) && letterCount[letter] > 0) {
        ...
        document.getElementById("notInWordList").style.display = "block";
        removeError();
      }
    }
  }
